# src-django
[![GitHub license](https://img.shields.io/github/license/WeixinCloud/src-express)](https://github.com/WeixinCloud/src-express)
...
## 快速开始
前往 [微信云托管快速开始页面](https://developers.weixin.qq.com/miniprogram/dev/src/src/basic/guide.html)，选择相应语言的模板，根据引导完成部署。

## 本地调试
下载代码在本地调试，请参考[微信云托管本地调试指南](https://developers.weixin.qq.com/miniprogram/dev/src/src/guide/debug/)。
